...
namespace hpx { namespace serialization
{
    ...
    inline serialization_chunk create_pointer_chunk(void const* pos, std::size_t size, boost::uint32_t rkey=0)
    {
        serialization_chunk retval = {
            { 0 }, size, static_cast<boost::uint8_t>(chunk_type_pointer), rkey
        };
